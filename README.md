...
#### api documentation for  [reselect (v3.0.0)](https://github.com/reactjs/reselect#readme)  [![npm package](https://img.shields.io/npm/v/npmdoc-reselect.svg?style=flat-square)](https://www.npmjs.org/package/npmdoc-reselect) [![travis-ci.org build-status](https://api.travis-ci.org/npmdoc/node-npmdoc-reselect.svg)](https://travis-ci.org/npmdoc/node-npmdoc-reselect)
...
![npmPackageListing](https://npmdoc.github.io/node-npmdoc-reselect/build/screenCapture.npmPackageListing.svg)

![npmPackageDependencyTree](https://npmdoc.github.io/node-npmdoc-reselect/build/screenCapture.npmPackageDependencyTree.svg)
